...
template int apply<S, wrapper::layout::aos>(int N, wrapper::wrapper<S, std::span, wrapper::layout::aos> w);
template int apply<S, wrapper::layout::soa>(int N, wrapper::wrapper<S, std::span, wrapper::layout::soa> w);
